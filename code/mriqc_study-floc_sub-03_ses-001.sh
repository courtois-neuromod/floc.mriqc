...
datalad containers-run -m 'mriqc_sub-03/ses-001' -n containers/bids-mriqc --input sourcedata/floc/sub-03/ses-001/fmap/ --input sourcedata/floc/sub-03/ses-001/func/ --output . -- -w workdir/ --participant-label 03 --session-id 001 --omp-nthreads 8 --nprocs 8 -m bold --mem_gb 32 --no-sub sourcedata/floc ./ participant 
mriqc_exitcode=$?
