...
datalad containers-run -m 'mriqc_sub-02/ses-001' -n bids-mriqc --input sourcedata/floc/sub-02/ses-001/fmap/ --input sourcedata/floc/sub-02/ses-001/func/ --output . -- -w workdir/ --participant-label 02 --session-id 001 --omp-nthreads 8 --nprocs 8 -m bold --mem_gb 32 --no-datalad-get  --no-sub sourcedata/floc ./ participant 
mriqc_exitcode=$?
