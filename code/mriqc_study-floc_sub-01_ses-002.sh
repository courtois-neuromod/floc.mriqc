...
datalad containers-run -m 'mriqc_sub-01/ses-002' -n bids-mriqc --input sourcedata/floc/sub-01/ses-002/fmap/ --input sourcedata/floc/sub-01/ses-002/func/ --output . -- -w workdir/ --participant-label 01 --session-id 002 --omp-nthreads 8 --nprocs 8 -m bold --mem_gb 32 --no-sub sourcedata/floc ./ participant 
mriqc_exitcode=$?
