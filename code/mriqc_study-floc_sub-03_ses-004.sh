...
datalad containers-run -m 'mriqc_sub-03/ses-004' -n bids-mriqc --input sourcedata/floc/sub-03/ses-004/fmap/ --input sourcedata/floc/sub-03/ses-004/func/ --output . -- -w workdir/ --participant-label 03 --session-id 004 --omp-nthreads 8 --nprocs 8 -m bold --mem_gb 32 --no-datalad-get  --no-sub sourcedata/floc ./ participant 
mriqc_exitcode=$?
