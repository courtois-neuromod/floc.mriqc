...
datalad containers-run -m 'mriqc_sub-02/ses-006' -n bids-mriqc --input sourcedata/floc/sub-02/ses-006/fmap/ --input sourcedata/floc/sub-02/ses-006/func/ --output . -- -w workdir/ --participant-label 02 --session-id 006 --omp-nthreads 8 --nprocs 8 -m bold --mem_gb 32 --no-sub sourcedata/floc ./ participant 
mriqc_exitcode=$?
